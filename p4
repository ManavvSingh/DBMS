...
INSERT INTO STUDENT VALUES ('1RN15CS091','SANTOSH','MANGALURU',881233220,'M');
...
INSERT INTO STUDENT VALUES ('1RN16CS122','VINAYAKA','CHIKAMAGALUR',880088001,'M');
...
-- 4) Calculate the FinalIA (average of the best two test marks) and update the corresponding table for all students.
UPDATE IAMARKS
